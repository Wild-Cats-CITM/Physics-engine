...
update_status ModulePhysics::PreUpdate(float dt)
{
	...
	while (Objects != NULL)
	{
		...
		Objects->data->acc.x -= Objects->data->aerodinamics(world->density, Objects->data->speed.x, Objects->data->h, world->coefAero, dt);
		Objects->data->acc.y -= Objects->data->aerodinamics(world->density, Objects->data->speed.y, Objects->data->w, world->coefAero, dt);
		LOG("%f, %f", Objects->data->acc.x, Objects->data->acc.y);
